...
- Before apply yaml files, should prequisited: provision eks, provision maria db: 10.11.10 then create db with name **[keycloakdbrds]**, update value **[username/password]** to **01.secret-db.yaml**<br>
