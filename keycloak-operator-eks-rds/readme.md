...
<br>
Notes: <br>
- For cert: If you dont have cert, you can use openssl to generate key.pem, key and add it to AWS Certificate manager, <br/>
the ALB needs cert imported to offload at ALB https side. <br/>
